...
namespace TestImageCrop
{
    public static class ImageHelper
    {
        ...
        public static byte[] CropImage(Bitmap sourceBitmap, int x, int y, int width, int height)
        {
                //Get new dimensions
        ...
        public static byte[] CropImage(MemoryStream content, int x, int y, int width, int height)
        {
